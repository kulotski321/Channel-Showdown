            ...
            override fun onResponse(call: Call<EventData>?, response: Response<EventData>?) {
                if (response!!.isSuccessful) {
                    ...
                    if (event != null) {
                        ...
                        picasso.load(ApiUtils.BASE_URL + myEvent.eventImage).placeholder(R.drawable.logo).resize(90,90).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).into(event_picture)
